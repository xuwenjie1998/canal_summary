 ...
 * @description: csbr_purchase_data.tr_order
 * @author: ASUS
...
public class OrderListener {
    ...
    public void onEventInsertData(CanalMsg canalMsg, CanalEntry.RowChange rowChange) throws Exception {
        Map<String, String> orderMap = eventData.insertDate(canalMsg, rowChange);
        if (CollectionUtils.isEmpty(orderMap)) {
            return;
        }
        dwsService.insertOrder(orderMap);
        log.info("====================== INSERT END =============================");
    }
    ...
    public void onEventDeleteData(CanalEntry.RowChange rowChange, CanalMsg canalMsg) throws Exception {
        ...
        dwsService.insertOrder(deleteMap);
        log.info("===================== DELETE END =================================");
    }
